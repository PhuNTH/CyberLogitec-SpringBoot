...
@Configuration
@ComponentScan(basePackages = { "com.SpringBootApplication.service" })
public class AppConfig {
    ...
    // scan tất cả những mapper package com.SpringBootApplication.mapper
    @Bean
    public MapperScannerConfigurer mapperScannerConfigurer() {
        MapperScannerConfigurer mapperScannerConfigurer = new MapperScannerConfigurer();
        mapperScannerConfigurer.setBasePackage("com.SpringBootApplication.mapper");
